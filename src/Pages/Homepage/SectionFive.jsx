    ...
    <section className="bg-black text-center text-white p-6 pb-32 mb-32">
      ...
      <div className="bg-blue-700 rounded-2xl px-4 py-6 my-6 max-w-[480px] mx-auto">
        <div className="mb-12">
          ...
          <div>
            <div className="justify-center items-start flex flex-col my-4 gap-2 w-fit text-sm mx-auto">
          ...
          <div>
            <div className="justify-center items-start flex flex-col my-4 gap-2 w-fit text-sm mx-auto">
              <div className="flex gap-4">
                ...
                <p>Collaborations with influencers</p>
              </div>
              <div className="flex gap-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          <div className="flex gap-6 justify-center">
            ...
            <p className="text-xl font-bold">Phase 3</p>
          </div>

          <div>
            <div className="ustify-center items-start flex flex-col my-4 gap-2 w-fit text-sm mx-auto">
              <div className="flex gap-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
